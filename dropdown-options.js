...
const peltPatternsTortie = ['tabby', 'ticked', 'mackerel', 'classic', 'sokoke', 'agouti', 'speckled', 'rosette', 'singlecolour', 'twocolour', 'smoke', 'singlestripe', 'bengal', 'marbled', 'masked', 'tortie', 'calico'];
